...
class Trs398_photons(db.Model):
    ...
    #temp_press_p = db.Column(db.Integer, db.ForeignKey("temp_press.id", ondelete='CASCADE'), nullable= True)
    #pdd_data_p = db.Column(db.Integer, db.ForeignKey("pdd_data_photons.id", ondelete='CASCADE'), nullable= True)
...
class Trs398_electrons(db.Model):
    ...
    #temp_press_e = db.Column(db.Integer, db.ForeignKey("temp_press.id", ondelete='CASCADE'), nullable= True)
    #pdd_data_e = db.Column(db.Integer, db.ForeignKey("pdd_data_electrons.id", ondelete='CASCADE'), nullable= True)
