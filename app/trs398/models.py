...
#    m_tpr = db.Column(db.Float)
    ...
    temp_press_p = db.Column(db.Integer, db.ForeignKey("temp_press.id", ondelete='CASCADE'), nullable= False)
    pdd_data_p = db.Column(db.Integer, db.ForeignKey("pdd_data_photons.id", ondelete='CASCADE'), nullable= False)
...
class Trs398_electrons(db.Model):
    ...
    temp_press_e = db.Column(db.Integer, db.ForeignKey("temp_press.id", ondelete='CASCADE'), nullable= False)
    pdd_data_e = db.Column(db.Integer, db.ForeignKey("pdd_data_electrons.id", ondelete='CASCADE'), nullable= False)
...
class Pdd_data_photons(db.Model):
    ...
    trs398_pdd_data_p = db.relationship('Trs398_photons', backref='beam_data_p', lazy='dynamic', passive_deletes=True)
...
class Pdd_data_electrons(db.Model):
    ...
    trs398_pdd_data_e = db.relationship('Trs398_electrons', backref='beam_data_e', lazy='dynamic', passive_deletes=True)
